 ...
 */
final class Version20211027210446 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE document (id INT NOT NULL, user_document_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, date_enregistrement DATE NOT NULL, adresse VARCHAR(255) NOT NULL, etat BOOLEAN NOT NULL, numero INT NOT NULL, date_expiration DATE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_D8698A766A24B1A2 ON document (user_document_id)');
        $this->addSql('CREATE TABLE image (id INT NOT NULL, document_id INT DEFAULT NULL, url VARCHAR(255) NOT NULL, taille NUMERIC(10, 0) NOT NULL, description TEXT DEFAULT NULL, PRIMARY KEY(id))');
