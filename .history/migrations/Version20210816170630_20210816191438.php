...
final class Version20210816170630 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document ALTER date_expiration TYPE DATE)
        $this->addSql('ALTER TABLE document ALTER date_expiration TYPE DATE USING USING date_expiration::date');
